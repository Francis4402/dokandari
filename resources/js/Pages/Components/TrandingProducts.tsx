...
const TrandingProducts = ({trandingproduct}: {trandingproduct: Product[]}) => {
  ...
  useEffect(() => {
    if (trandingproduct && trandingproduct.length > 0) {
      const parsed = trandingproduct.map(item => ({
        ...item,
        ...
        <div className="swiper-container">
          ...
          >
            {parsedProducts.map((offer, index) => {
              ...
              const saveAmount = calculateSaveAmount(offer.regular_price.toString(), offer.sale_price.toString());
