...
const Analytics = ({ user }: PageProps) => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex space-x-3">
                ...
                <button className="inline-flex items-center px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg shadow-lg hover:from-blue-700 hover:to-blue-800 transition-all">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className={`flex items-center mt-2 ${getMetricColor(salesGrowth)}`}>
                    ...
                    <span className="ml-1 font-medium">{salesGrowth}%</span>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-800 mt-1">{totalOrders.toLocaleString()}</p>
                  <div className={`flex items-center mt-2 ${getMetricColor(orderGrowth)}`}>
                    {getMetricIcon(orderGrowth)}
                    <span className="ml-1 font-medium">{orderGrowth}%</span>
                    <span className="text-gray-500 text-sm ml-2">vs last period</span>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-800 mt-1">{totalCustomers.toLocaleString()}</p>
                  <div className={`flex items-center mt-2 ${getMetricColor(customerGrowth)}`}>
                    {getMetricIcon(customerGrowth)}
                    <span className="ml-1 font-medium">{customerGrowth}%</span>
                    <span className="text-gray-500 text-sm ml-2">vs last period</span>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-800 mt-1">${avgOrderValue.toFixed(2)}</p>
                  ...
                  <div key={product.id} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <div className="flex items-center">
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-blue-100 to-blue-200 flex items-center justify-center mr-3">
                        <FaProductHunt className="h-5 w-5 text-blue-600" />
                      </div>
                      <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* Revenue by Category */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-6">Revenue by Category</h3>
              <div className="space-y-4">
                {salesData.topCategories.map((category, index) => (
                  <div key={category.category} className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <span className="font-bold text-gray-800">${category.sales.toLocaleString()}</span>
            ...
            {/* Revenue by Region */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-6">Revenue by Region</h3>
              <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 mt-1">
                    ${salesData.customerMetrics.acquisitionCost.toFixed(2)}
                  </p>
                  <div className={`flex items-center mt-2 ${getMetricColor(-5.2)}`}>
                    {getMetricIcon(-5.2)}
                    <span className="ml-1 font-medium">5.2%</span>
                    <span className="text-gray-500 text-sm ml-2">decrease</span>
                  </div>
                </div>
                <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                  <FaPercentage className="h-5 w-5 text-blue-600" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 mt-1">
                    ${salesData.customerMetrics.lifetimeValue.toFixed(2)}
                  </p>
                  <div className={`flex items-center mt-2 ${getMetricColor(15.5)}`}>
                    {getMetricIcon(15.5)}
                    <span className="ml-1 font-medium">15.5%</span>
                    <span className="text-gray-500 text-sm ml-2">increase</span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className={`flex items-center mt-2 ${getMetricColor(-2.1)}`}>
                    {getMetricIcon(-2.1)}
                    <span className="ml-1 font-medium">2.1%</span>
                    <span className="text-gray-500 text-sm ml-2">decrease</span>
                  </div>
                </div>
                <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center">
                  <FaExchangeAlt className="h-5 w-5 text-orange-600" />
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Performance Summary */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-6">Performance Summary</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                <FaRegClock className="h-8 w-8 text-blue-600 mx-auto mb-3" />
                <p className="text-sm font-medium text-gray-600">Average Order Processing</p>
                <p className="text-xl font-bold text-gray-800 mt-1">2.4 hours</p>
              </div>
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl">
                <FaShoppingBag className="h-8 w-8 text-green-600 mx-auto mb-3" />
                <p className="text-sm font-medium text-gray-600">Conversion Rate</p>
                <p className="text-xl font-bold text-gray-800 mt-1">3.8%</p>
              </div>
              <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl">
                <FaChartBar className="h-8 w-8 text-purple-600 mx-auto mb-3" />
                <p className="text-sm font-medium text-gray-600">Bounce Rate</p>
                <p className="text-xl font-bold text-gray-800 mt-1">42.5%</p>
              </div>
              <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl">
                <FaChartPie className="h-8 w-8 text-orange-600 mx-auto mb-3" />
                <p className="text-sm font-medium text-gray-600">Profit Margin</p>
                <p className="text-xl font-bold text-gray-800 mt-1">28.7%</p>
              </div>
            </div>
          </div>
        </div>
