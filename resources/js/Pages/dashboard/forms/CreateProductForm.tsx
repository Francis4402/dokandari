...
export default function CreateProductForm({auth}: PageProps) {
  ...
  const handleSubmit = () => {
    ...
    if (data.regular_price && isNaN(parseFloat(data.regular_price))) {
      newErrors.regular_price = 'Please enter a valid price';
    }
    if (data.sale_price && isNaN(parseFloat(data.sale_price))) {
      newErrors.sale_price = 'Please enter a valid sale price';
    }
  ...
  const handleNumberInput = (
    ...
    if (value === '' || /^\d*\.?\d*$/.test(value)) {
      handleDataChange(key, value as any);
    }
  };
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (!e.target.checked) handleDataChange('sale_price', '');
                    }}
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) => handleDataChange('inStock', e.target.checked)}
                  className="h-5 w-5 rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
